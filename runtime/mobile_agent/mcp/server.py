...
class McpServer:
    ...
    def _invoke(
        ...
        handlers: dict[str, Callable[[], dict[str, Any]]] = {
            ...
            "mobile_inspect_app_state": lambda: self._client.inspect_app_state(
                arguments["device_id"], arguments["app_id"]
            ),
            "mobile_launch_app": lambda: self._client.launch_app(arguments),
            "mobile_stop_app": lambda: self._client.stop_app(arguments),
            "mobile_prepare_app_data_clear": lambda: (
                self._client.prepare_app_data_clear(arguments)
            ),
            "mobile_clear_app_data": lambda: self._client.clear_app_data(arguments),
